                            ...
                            <div class="table-responsive">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3 text-center">
                                        <a href="profesorAdmin/create" class="btn btn-primary">Crear Profesor</a>
                                    </div>
                                </div>
                                ...
                                <table class="table align-items-center mb-0 results"
                                    ...
                                    <tbody>
                                        ...
                                        @php $i = $i + 1;@endphp
                                            <tr @if($profesor->priority == 1)class="text-info" @endif @php if($i == 8){ echo 'style="border: salmon;"'; } @endphp  >
                                                <td>
                                                ...
                                                <td>
                                                    <span class="text-xs font-weight-bold text-truncate">{{ $profesor->nombre }}
                                                    </span>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <span class="text-xs font-weight-bold">
                                                        {{ $profesor->linkedin }}</span>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <span class="text-xs font-weight-bold">
                                                        {{ $profesor->created_at }}</span>
                                                </td>

                                                <td class="align-middle text-center">
                                                    <div class="btn-group">
                                                        <a href="/profesorAdmin/{{ $profesor->id }}"
                                                            title="Ver Mensaje"
                                                        ...
                                                        <form action="/profesorAdmin/{{ $profesor->id }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                onclick="return confirm('¿Quieres eliminar este profesor?')"
                                                                title="Eliminar"
