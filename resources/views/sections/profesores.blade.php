            ...
            <div class="row">
                <div class="col-lg-3 mb-lg-0 mb-6 mt-5">
                    <div class="card" data-animation="true">
                        <div class="card-header p-0 position-relative mt-4 mx-3
                            z-index-2">
                            <a class="d-block blur-shadow-image">
                                <img src="{{asset('assets/assets/img/climb/profesor.jpg')}}"
                                    alt="img-blur-shadow"
                        ...
                        <div class="card-body text-center">
                            <div class="d-flex mt-n6 mx-auto">
                                <a class="btn btn-link text-primary border-0"
                            ...
                            <h5 class="font-weight-normal">
                                <a href="javascript:;">Carlos Alberto Garcia</a>
                            </h5>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-5 mx-auto text-center mt-5 ">
                <button type="button" class="btn btn-outline-light
                    text-white mb-0 pl-5 pr-5" style="font-size:
                    large;padding-left: 5rem; padding-right: 5rem;">Ser
                    profe CLIMB</button>
            </div>
        </div>
    </div>
