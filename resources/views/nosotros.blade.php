      ...
      <div class="container">
        <div class="row justify-content-center" style="margin-top: 18rem;">
               {{--  <div class="col-lg-7 text-center mx-auto">
                  <img src="{{asset('assets/assets/img/climb/climbLogoLetras.png')}}" class="img-fluid" alt="">
                  <p class="lead text-primary mt-3"><br />Desarrollamos tus habilidades para la
                    gestión del talento con profesionales.</p>
                </div> --}}
              
          <div class="col-lg-8 text-center mx-auto my-auto mb-7">
            <h1 class="text-white">Nuestra Historia</h1>
            
            <p class="lead mb-4 text-white opacity-8">Quienes somos? que queremos? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tenetur nostrum officiis similique fugiat dolore. Mollitia accusamus magni, alias autem totam reiciendis quae impedit ratione? Accusamus et odio ratione sapiente voluptatem.</p>
